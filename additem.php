...
$sql="INSERT INTO itemlist(ProductName,Price,Qty,ExpDate) VALUES(:ProductName,:Price,:Qty,'$ExpDate')";
...
<head>
	...
	<title>Fast Food Management | Admin Post Item</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Input an Item</h2>
...
<?php $ret="select id,categ from category";
...
{
?>
<option value="<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->categ);?></option>
<?php }} ?>
...
<div class="form-group">
<label class="col-sm-2 control-label">Exp.Date<span style="color:red">*</span></label>
<div class="col-sm-4">
